...
// Encoding and decoding functions for EphemeralKeyPair
export const EphemeralKeyPairEncoding = {
  decode: (e: any) => EphemeralKeyPair.fromBytes(e.data), // Adjust type if possible
...
export const createEphemeralKeyPair = ({
  expiryDateSecs = Math.floor(Date.now() / 1000) + 24 * 60 * 60, // Convert to number
